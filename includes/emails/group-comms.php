...
function bys_get_comm_email( string $prompt_type, array $vars ): array {
	...
	switch ( $prompt_type ) {
		...
		case 'course-progress':
			return bys_get_course_nudge_email( $group_name, $recipient_name, $site_name, $site_url );
		case 'assessment-deadline':
			return bys_get_assessment_deadline_email( $group_name, $recipient_name, $site_name, $site_url );
		case 'welcome-reminder':
			return bys_get_welcome_reminder_email( $group_name, $recipient_name, $site_name, $site_url );
		case 'custom':
 ...
 */
function bys_get_course_nudge_email( string $group_name, string $recipient_name, string $site_name, string $site_url ): array {
 ...
 */
function bys_get_assessment_deadline_email( string $group_name, string $recipient_name, string $site_name, string $site_url ): array {
 ...
 */
function bys_get_welcome_reminder_email( string $group_name, string $recipient_name, string $site_name, string $site_url ): array {

...
jQuery(document).ready(function ($) {
  ...
  $block.find('.filters__form').on('submit', async function (e) {
    ...
    const hasRowFilter = activeFilters.userIds.length > 0 || activeFilters.courseStatus || activeFilters.userStatus || activeFilters.enrolmentDate || activeFilters.completionDate;

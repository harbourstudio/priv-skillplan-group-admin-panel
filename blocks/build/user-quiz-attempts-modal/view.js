...
jQuery(document).ready($ => {
  ...
  $(window).on('bysQuizAttemptsOpen', async function (_event, data) {
    ...
    try {
      ...
      const attempts = await _shared_api_client_js__WEBPACK_IMPORTED_MODULE_0__.api.get(_shared_api_client_js__WEBPACK_IMPORTED_MODULE_0__.endpoints.userQuizAttemptsDetails(data.userId, data.quizId));

...
<div <?= $wrapper_attributes; ?>>
    ...
    <div class="gcl__card">
        <div class="gcl__list">
            <?php for ($i = 0; $i < 3; $i++ ) : ?>
            <div class="gcl__item" role="status" aria-busy="true" aria-live="polite">
                <span class="gcl__date"><span class="skeleton"></span></span>
                <span class="gcl__label"><span class="skeleton"></span></span>
                <span class="gcl__badge"><span class="skeleton"></span></span>
            </div>
            <?php endfor; ?>
        </div>
    </div>

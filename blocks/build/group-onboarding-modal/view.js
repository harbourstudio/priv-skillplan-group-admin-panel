...
(() => {
/*!********************************************!*\
  !*** ./src/group-onboarding-modal/view.js ***!
  \********************************************/
__webpack_require__.r(__webpack_exports__);
...
jQuery(document).ready($ => {
  ...
  function markSeen() {
    _shared_api_client_js__WEBPACK_IMPORTED_MODULE_0__.api.post(_shared_api_client_js__WEBPACK_IMPORTED_MODULE_0__.endpoints.markTutorialSeen()).catch(() => {});
  }
